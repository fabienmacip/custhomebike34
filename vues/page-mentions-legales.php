...
<?php
    $_RAISON_SOCIALE = "CUST'HOME BIKE 34";
    $_CAPITAL = "1 000,00";
    $_RCS = "RCS B&eacute;ziers 894 130 251";
    $_ADRESSE_SIEGE_SOCIAL = "5, Avenue Pierre de Coubertin - 34500 BEZIERS";
    $_TELEPHONE = "06 68 93 26 39";
    $_MAIL = "contact@custhomebike34.fr";
    $_TVA = "FR04894130251";
    $_DIRECTEUR_PUBLICATION = "Monsieur Rapha&euml;l DIETRICH"; 
